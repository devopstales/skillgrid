...
- `[BRIEF_FILE]` — the task brief file (`scripts/task-brief PLAN N` prints the path).
- `[REPORT_FILE]` — the file the implementer writes its detailed report to (name it after the brief: brief `…/task-N-brief.md` → report `…/task-N-report.md`).
