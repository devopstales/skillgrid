...
> Copy this template to `docs/PRD.md` and fill in every section before
> implementation. For a multi-project repo, merge rather than overwrite:
> keep existing content and add the new project's scope alongside it.
