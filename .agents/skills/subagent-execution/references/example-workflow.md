...
A worked, end-to-end run of the subagent-execution loop, loaded on demand from
`subagent-execution` SKILL.md as a concrete reference for the Setup → Task Loop
→ Final QA Gate → Final Review → Finish sequence.
