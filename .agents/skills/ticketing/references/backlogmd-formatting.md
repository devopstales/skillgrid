...
type: feature
references:
  - .skillgrid/specs/YYYY-MM-DD-<topic>/briefing.md
  - path/or/url/related
documentation:
  - .skillgrid/specs/YYYY-MM-DD-<topic>/briefing.md
---
...
2. {Follow briefing.md blueprint or concrete implement steps}
...
| `references` | **yes** | Non-empty list of paths/URLs an agent needs. SDD tickets: always include `briefing.md` (+ `tasks.md` / `acceptance.feature` as relevant). |
