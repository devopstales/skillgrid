# based on skillgrid-v2:_shared/issue-tracker/github-formatting.md

# GitHub: issue formatting (milestones and issues)

Shared formatting conventions for GitHub work. Consumed by the `ticketing` skill when the resolved tracker is GitHub (see `github.md` for CLI conventions).
