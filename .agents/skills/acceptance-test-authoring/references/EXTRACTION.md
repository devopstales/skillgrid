...
Extraction **synthesizes** the Gherkin structure from the headings and copies fenced step lines verbatim, writing each `spec.md` to `.skillgrid/acceptance-tests/.extracted/<same-relative-path>/spec.feature`.
