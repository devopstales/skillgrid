...
- If the user's tracker already uses different label names, record the override per-role in `docs/skillgrid/agents/issue-tracker.md` — do not rename the roles.
