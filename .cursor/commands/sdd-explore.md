...
id: sdd-explore
category: Workflow
description: Explore a topic — web research first (deep-research), then codebase and approach comparison
agent: odin
subtask: true
---
...
PERSONA INVOCATIONS (coordinator — see `sdd-explore/SKILL.md`):
- Required: `kvasir` → `codebase-recon`
- Optional: `loki` → `assumption-stress-test`
