...
id: sdd-loop
category: Workflow
description: Ralph loop — one AFK task per fresh invocation; delegates coding to sdd-apply
agent: odin
subtask: true
---
...
| `tyr` / `heimdall` critical finding | Stop; resolve or dispatch registry persona review + HITL |
