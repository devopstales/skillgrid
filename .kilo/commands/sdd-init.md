...
You are an SDD sub-agent. Read the skill file at .agents/skills/sdd-init/SKILL.md FIRST, then follow its instructions exactly.
...
## OpenSpec guided onboarding (integrated from former opsx-onboard)
...
> OpenSpec CLI is not installed. Install it first, then come back to `/sdd-init`.
...
|---------|--------------|
| `/sdd-brainstorm` | Create a change and generate all artifacts |
...
| Command | What it does |
|---------|--------------|
| `/sdd-brainstorm` | Start a new change, step through artifacts one at a time |
| `/sdd-brainstorm` | Continue working on an existing change |
| `/sdd-brainstorm` | Fast-forward: create all artifacts at once |
| `/sdd-verify` | Verify implementation matches artifacts |

---

## What's Next?

Try `/sdd-brainstorm` on something you actually want to build. You've got the rhythm now!
```
...
- `/sdd-brainstorm <name>` - Resume artifact creation
- `/sdd-apply <name>` - Jump to implementation (if tasks exist)
...
| Command | What it does |
|---------|--------------|
| `/sdd-brainstorm <name>` | Create a change and generate all artifacts |
| `/sdd-explore` | Think through problems (no code changes) |
| `/sdd-apply <name>` | Implement tasks |
| `/sdd-archive <name>` | Archive when done |

**Additional commands:**

| Command | What it does |
|---------|--------------|
| `/sdd-brainstorm <name>` | Start a new change, step by step |
| `/sdd-brainstorm <name>` | Continue an existing change |
| `/sdd-brainstorm <name>` | Fast-forward: all artifacts at once |
| `/sdd-verify <name>` | Verify implementation |

Try `/sdd-brainstorm` to start your first change.
```
